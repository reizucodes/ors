<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="address" type="text" class="mt-1 block w-full" wire:model.defer="state.address" autocomplete="address" placeholder="Street, Brgy, Municipality/ City, Province, ZIP Code  " />
            <x-jet-input-error for="name" class="mt-2" />
        ...
        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="email2" value="{{ __('Email') }}" />
